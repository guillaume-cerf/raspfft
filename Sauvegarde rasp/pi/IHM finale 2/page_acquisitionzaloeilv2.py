...
# Form implementation generated from reading ui file 'C:\Users\cyril\Downloads\page_acquisitionzaloeilv2.ui'
#
...
from matplotlibwidget_linux import MatplotlibWidget ####evite probleme en allant sur raspberry : a ete copie dans le dossier "Projet Raspberry" et est a mettre sur cle USB
...
class Ui_Acquisition(object):
    def setupUi(self, Acquisition):
        ...
        Acquisition.showMaximized()  #plein écran
        #Acquisition.showFullScreen()  #affichage plein ecran sans reduire fermer etc
        ...
        self.checkBox_accelx.setStyleSheet(_fromUtf8("color: rgb(255, 0, 0);"))
        ...
        self.checkBox_accely.setStyleSheet(_fromUtf8("color:rgb(0, 0, 255)"))
        ...
        self.checkBox_accelz.setStyleSheet(_fromUtf8("color:rgb(0, 170, 0)"))
        ...
        self.PushButton_Init = QtGui.QPushButton(Acquisition)
        ...
        self.label.setPixmap(QtGui.QPixmap(_fromUtf8("ensam-logo.png"))) ###insertion image
        ...
        self.gridLayout.addItem(spacerItem16, 8, 2, 1, 1)
    ...
    def retranslateUi(self, Acquisition):
        ...
        self.PushButton_Init.setText(_translate("Acquisition", "Initialisation", None))
